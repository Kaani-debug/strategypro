...
const MOCK_USERS = [
  { id: 'U002', email: 'admin@strategypro.com', passwordHash: seedHash.admin123, name: 'Admin User', role: 'admin', avatar: 'AU', createdAt: '2024-11-01', status: 'active', bots: 0, balance: 50000 },
  { id: 'U003', email: 'super@strategypro.com', passwordHash: seedHash.super123, name: 'Super Admin', role: 'superadmin', avatar: 'SA', createdAt: '2024-06-01', status: 'active', bots: 0, balance: 100000 },
  { id: 'U004', email: 'john@example.com', passwordHash: seedHash.pass123, name: 'John Doe', role: 'user', avatar: 'JD', createdAt: '2025-03-10', status: 'active', bots: 3, balance: 12450 },
  { id: 'U005', email: 'jane@example.com', passwordHash: seedHash.pass123, name: 'Jane Smith', role: 'user', avatar: 'JS', createdAt: '2025-02-20', status: 'active', bots: 5, balance: 24800 },
  { id: 'U006', email: 'bob@example.com', passwordHash: seedHash.pass123, name: 'Bob Wilson', role: 'user', avatar: 'BW', createdAt: '2025-04-05', status: 'suspended', bots: 1, balance: 3200 },
  { id: 'U007', email: 'alice@example.com', passwordHash: seedHash.pass123, name: 'Alice Brown', role: 'user', avatar: 'AB', createdAt: '2025-01-25', status: 'active', bots: 2, balance: 8900 },
  { id: 'U008', email: 'alex@strategypro.com', passwordHash: seedHash.admin123, name: 'Alex Manager', role: 'admin', avatar: 'AM', createdAt: '2024-12-01', status: 'active', bots: 0, balance: 25000 },
]
...
export function updateUserRecord(id, updates) {
  ...
  const next = { ...users[idx], ...updates, passwordHash: users[idx].passwordHash, password: users[idx].password }
  users[idx] = next
  writeUsers(users)
...
export async function resetUserPassword(id, password) {
  ...
  users[idx] = { ...users[idx], passwordHash, password: undefined }
  writeUsers(users)
  return { success: true }
}
